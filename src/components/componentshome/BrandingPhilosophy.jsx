const BrandingPhilosophy = () => {
    return (
        <section className="py-30 bg-surface-container-low">
            <div className="max-w-360 mx-auto px-20 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="order-1 md:order-2 space-y-8">
                    <h2 className="font-LibreCaslonText text-5xl text-on-surface leading-tight">Moda feita para o seu movimento</h2>
