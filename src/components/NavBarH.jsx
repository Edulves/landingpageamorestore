const NavBarH = () => {
    return (
        <header className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-md">
            <div className="flex justify-between items-center w-full px-20 max-w-360 mx-auto h-20">
                <div className="flex items-center gap-8">
                    ...
                    />
                    <nav className="hidden md:flex items-center gap-6 leading-6 font-manrope uppercase tracking-wider">
